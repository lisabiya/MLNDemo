...
import com.debby.mlnsample.base.BaseApplication;
...
public class ResourcesUtils {
    ...
    public static int getResourceIdByName(String name, TYPE type) {
        return getResources().getIdentifier(name, type.toString(), BaseApplication.Companion.getPackageNameImpl());
    }
    ...
    public static Resources getResources() {
        return BaseApplication.Companion.getApp().getResources();
    }
}